...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Istana Laundry</title>
    ...
    <main class="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div class="max-w-md w-full text-center space-y-6">
            ...
            <div class="relative inline-flex items-center justify-center">
                <div class="w-28 h-28 rounded-3xl bg-orange-500/10 dark:bg-orange-500/20 border border-orange-500/20 flex items-center justify-center shadow-xl shadow-orange-500/5">
                    <span class="material-symbols-outlined text-6xl text-primary animate-pulse">search_off</span>
                </div>
                <div class="absolute -bottom-2 -right-2 px-3 py-1 bg-slate-900 text-white dark:bg-slate-800 text-xs font-black rounded-lg shadow-md font-mono border border-slate-700">
                    404 ERROR
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-sm mx-auto leading-relaxed">
                    Maaf, tautan atau halaman yang Anda tuju tidak ditemukan, telah dipindahkan, atau alamat URL yang Anda masukkan kurang tepat.
                </p>
            </div>

            <!-- Action Buttons -->
            <div class="pt-2 flex flex-col sm:flex-row gap-3 justify-center items-center">
                <a href="{{ url('/dashboard') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-primary hover:bg-primary-hover text-white text-xs font-bold shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98]">
                    <span class="material-symbols-outlined text-base">home</span>
                    <span>Kembali ke Dashboard</span>
                </a>
                <button onclick="window.history.back()" type="button" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-bold transition-all shadow-sm">
